...
class HomeKetertiban extends StatefulWidget {
  const HomeKetertiban({Key? key}) : super(key: key);

  @override
  State<HomeKetertiban> createState() => _HomeKetertiban();
}

class _HomeKetertiban extends State<HomeKetertiban> {
  @override
  Widget build(BuildContext context) {
    final user = FirebaseAuth.instance.currentUser!;
    const String apiUrl = 'http://10.0.2.2:8000/api/ketertiban';
    const String editUrl = 'http://10.0.2.2:8000/api/ketertiban/update/';
    const String createUrl = 'http://10.0.2.2:8000/api/ketertiban/create';
