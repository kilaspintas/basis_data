...
class HomeKebersihan extends StatefulWidget {
  const HomeKebersihan({Key? key}) : super(key: key);

  @override
  State<HomeKebersihan> createState() => _HomeKebersihan();

}

class _HomeKebersihan extends State<HomeKebersihan> {
  @override
  Widget build(BuildContext context) {
    final user = FirebaseAuth.instance.currentUser!;
    const String apiUrl = 'http://10.0.2.2:8000/api/kebersihan';
    const String editUrl = 'http://10.0.2.2:8000/api/kebersihan/update/';
    const String createUrl = 'http://10.0.2.2:8000/api/kebersihan/create';
